...
public class Utils {
    ...
    public static boolean rootRestrictDelete(File file) {
    ...
    public static String computeCommitID(String message, long timeMillis, String parentID, String secondParentID, TreeMap<String, String> blobsmap) {
        StringBuilder contents = new StringBuilder();
        contents.append(message).append('\n');
        contents.append(timeMillis).append('\n');
        contents.append(parentID == null ? "" : parentID).append('\n');
        contents.append(secondParentID == null ? "" : secondParentID).append('\n');
        contents.append(blobsmap);
